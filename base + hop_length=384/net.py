...
class MobileFaceNet(nn.Module):
    def __init__(self,
        ...
        self.fc_out = nn.Linear(1024, num_class)
        # init
...
class TgramNet(nn.Module):
    def __init__(self, num_layer=3, mel_bins=128, win_len=1024, hop_len=384):
...
class STgramMFN(nn.Module):
    def __init__(self, num_classes,
        ...
        self.arcface = ArcMarginProduct(in_features=1024, out_features=num_classes,
